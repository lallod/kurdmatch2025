    ...
    <main className="min-h-screen bg-gray-50 text-gray-900">
      <header className="bg-white border-b sticky top-0 z-50">
        <div className="container flex items-center justify-between h-16 px-4">
          ...
          <Button onClick={handleSave} className="bg-gradient-to-r from-tinder-rose to-tinder-orange hover:from-tinder-rose/90 hover:to-tinder-orange/90">
      ...
      <div className="container px-4 py-6 max-w-6xl mx-auto">
        <Tabs defaultValue="basic" value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="basic">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Edit the basic profile information.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="lastActive" defaultValue="2 hours ago" />
                  </div>
                </div>
                <div className="space-y-2">
          ...
          <TabsContent value="photos">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage profile photos.</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="aspect-square rounded-lg border-2 border-dashed flex items-center justify-center bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer">
            ...
            <ScrollArea className="h-[calc(100vh-200px)]">
              <Card className="mb-6">
                <CardHeader>
                  ...
                  <CardDescription>Edit your profile's personal information.</CardDescription>
                </CardHeader>
                <CardContent>
          ...
          <TabsContent value="preferences">
            <Card className="mb-6">
              <CardHeader>
                <CardTitle>Favorites & Preferences</CardTitle>
                <CardDescription>Edit your favorite things and preferences.</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                  <DetailEditor 
