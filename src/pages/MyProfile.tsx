...
const MyProfile = () => {
  ...
  const profileData: ProfileData = realProfileData ? {
    ...
    growthGoals: (realProfileData as any).growth_goals || [],
    hiddenTalents: (realProfileData as any).hidden_talents || [],
    favoriteMemory: (realProfileData as any).favorite_memory || '',
    stressRelievers: (realProfileData as any).stress_relievers || [],
    charityInvolvement: (realProfileData as any).charity_involvement || '',
    musicInstruments: (realProfileData as any).music_instruments || [],
    favoriteGames: (realProfileData as any).favorite_games || [],
    techSkills: (realProfileData as any).tech_skills || [],
    dreamHome: (realProfileData as any).dream_home || '',
    transportationPreference: (realProfileData as any).transportation_preference || '',
    workEnvironment: (realProfileData as any).work_environment || '',
    favoriteSeason: (realProfileData as any).favorite_season || '',
    idealWeather: (realProfileData as any).ideal_weather || '',
    dreamVacation: (realProfileData as any).dream_vacation || '',
    financialHabits: (realProfileData as any).financial_habits || '',
  } : {
  ...
  const details = {
    ...
    growthGoals: (profileData as any).growthGoals || [],
    hiddenTalents: (profileData as any).hiddenTalents || [],
    favoriteMemory: (profileData as any).favoriteMemory || '',
    stressRelievers: (profileData as any).stressRelievers || [],
    charityInvolvement: (profileData as any).charityInvolvement || '',
    musicInstruments: (profileData as any).musicInstruments || [],
    favoriteGames: (profileData as any).favoriteGames || [],
    techSkills: (profileData as any).techSkills || [],
    dreamHome: (profileData as any).dreamHome || '',
    transportationPreference: (profileData as any).transportationPreference || '',
    workEnvironment: (profileData as any).workEnvironment || '',
    favoriteSeason: (profileData as any).favoriteSeason || '',
    idealWeather: (profileData as any).idealWeather || '',
    dreamVacation: (profileData as any).dreamVacation || '',
    financialHabits: (profileData as any).financialHabits || '',
    favoriteBooks: [],
    favoriteMovies: [],
    favoriteMusic: [],
    favoriteFoods: [],
