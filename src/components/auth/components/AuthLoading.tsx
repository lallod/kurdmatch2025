  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-dark via-primary-dark/80 to-primary">
      <div className="text-center">
        ...
        <p className="mt-4 text-primary-foreground text-lg">{t('auth.processing', 'Processing authentication...')}</p>
        <p className="mt-2 text-primary-foreground/80 text-sm">{t('auth.please_wait', 'Please wait while we complete your login...')}</p>
      </div>
    </div>
  );
};
