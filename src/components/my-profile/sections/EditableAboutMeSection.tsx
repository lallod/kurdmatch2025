  ...
  return (
    <div className="bg-card rounded-2xl p-4 shadow-sm">
      <div className="flex justify-between items-center mb-2">
        <h3 className="text-sm font-semibold text-foreground">{t('profile.about', 'About')}</h3>
        {!isEditing && (
          <Button
            variant="ghost"
            size="icon"
      ...
      {isEditing ? (
        <div className="space-y-3">
          <Textarea
            ...
            placeholder={t('profile.tell_about_yourself', 'Tell us about yourself... What makes you unique?')}
            autoFocus
          />
