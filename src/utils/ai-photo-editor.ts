...
// Configure transformers.js to use CDN and disable local models/caching for now
...
export const removeBackground = async (imageElement: HTMLImageElement): Promise<Blob> => {
  try {
    ...
    // Using a model fine-tuned for segmentation, which can be used for background removal.
    ...
    // This logic assumes the model's first result is the foreground.
    // We will use the mask to set the alpha channel.
